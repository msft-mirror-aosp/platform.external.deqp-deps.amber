...
## if (${Dawn_FOUND})
##   target_link_libraries(mylib Dawn::dawn)
## endif()
##

# Exports these settings to the includer:
#    Boolean Dawn_FOUND indicates whether we found Dawn.
#    If Dawn was found, then library dependencies for Dawn::dawn
#    will be set up.
...
#   the dawn libraries.
#
#     -DDawn_INCLUDE_DIR=<directory containing webgpu/webgpu.h>
#     -DDawn_GEN_INCLUDE_DIR=<directory containing generated headers>
#     -DDawn_LIBRARY_DIR=<directory containing monolithic webgpu_dawn library>
...
find_library(Dawn_LIBRARY
  ...
  PATHS
    "${Dawn_LIBRARY_DIR}"
    "${Dawn_LIBRARY_DIR}/src/dawn/native"
  )

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(Dawn
  DEFAULT_MSG
  Dawn_INCLUDE_DIR Dawn_LIBRARY
  )
